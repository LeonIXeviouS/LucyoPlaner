package com.example.leonixevious.lucyoplanerv2;
...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        bg = new Background(BitmapFactory.decodeResource(getResources(), R.drawable.background_game));
    ...
    public void updateTopBorder() {
        if (player.getScore() % 50 == 0) {
            topborder.add(new TopBorder(BitmapFactory.decodeResource(getResources(), R.drawable.ciel
            ...
            if (topborder.get(i).getX() < -20) {
                ...
                if (topDown) {
                    topborder.add(new TopBorder(BitmapFactory.decodeResource(getResources(),
                            R.drawable.ciel), topborder.get(topborder.size() - 1).getX() + 20,
    ...
    public void updateBottomBorder() {
        if (player.getScore() % 40 == 0) {
            botborder.add(new BotBorder(BitmapFactory.decodeResource(getResources(), R.drawable.eau),
    ...
    public void drawText(Canvas canvas) {
        ...
        if (!player.getPlaying() && newGameCreated && reset) {
            ...
            canvas.drawText("RESTE APPUYER POUR MONTER", WIDTH / 2 - 50, HEIGHT / 2 + 20, paint1);
            canvas.drawText("RELACHE POUR DECENDRE", WIDTH / 2 - 50, HEIGHT / 2 + 40, paint1);
        }
    }
}